...
startNext:
  ...
  Serial.print(F("i: "));
  Serial.println(i);
  Serial.print(F("currentAPData.key: "));
  Serial.println(currentAPData.key);
  Serial.print(F("currentAPData.ssid: "));
  Serial.println(currentAPData.ssid);
  Serial.print(F("currentAPData.pass: "));
  Serial.println(currentAPData.pass);
...
void getBmpData() {
  ...
  if (bmp.takeForcedMeasurement()) {
    ...
    Serial.print(tBmpInt);
    Serial.println(" *C");
    Serial.print(F("Pressure = "));
    Serial.print(pBmpInt);
    Serial.println(" mmHh");
    Serial.print(F("Approx altitude = "));
    Serial.print(aBmpInt);
    Serial.println(" m");
  } else {
...
void getAhtData() {
  ...
  Serial.print(tAthInt);
  Serial.println(" degrees C");
  Serial.print("Humidity: ");
  Serial.print(hAthInt);
  Serial.println("% rH");
}
