...
class MainButtonAction{
  ...
  Future<void> close() async => _throttler.throttle<void>(_close);
  ...
  Future<void> minimize() async => _throttler.throttle<void>(_minimize);
  Future<void> _minimize() async {
    await windowManager.minimize();
  }

  Future<void> stop() async => _throttler.throttle<void>(_stop);
  Future<void> _stop() async {
    BlocProvider.of<EnvironmentBloc>(context).add(const EnvironmentEvent.stopGet());
    await Future.delayed(const Duration(seconds: 1));
  }

  Future<void> start() async => _throttler.throttle<void>(_start);
  ...
  Future<void> restart() async => _throttler.throttle<void>(_restart);
  ...
  Future<bool?> pinWindows() async => _throttler.throttle<bool>(_pinWindows,);
